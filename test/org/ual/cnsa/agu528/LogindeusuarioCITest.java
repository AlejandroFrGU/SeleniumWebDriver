...
public class LogindeusuarioCITest {
	...
	public void logindeusuarioCI() {
		...
		// driver.findElement(By.cssSelector(".form-group:nth-child(2) >
		// .invalid-feedback")).click();
		// 8 | assertText | css=.form-group:nth-child(2) > .invalid-feedback | Please
		// enter your password.
		...
		// 16 | assertText | css=.text-danger | The credentials you entered are not
